...
[<assembly: AssemblyTitleAttribute("Aivika Simulation Experiment")>]
[<assembly: AssemblyProductAttribute("Aivika Simulation Experiment")>]
[<assembly: AssemblyDescriptionAttribute("A module for running Aivika simulation experiments")>]
