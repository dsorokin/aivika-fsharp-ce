...
let model = simulation {
    ...
    and i1 = List.item 0 i123
    and i2 = List.item 1 i123
    and i3 = List.item 2 i123
    and i4 = List.item 0 i45
    and i5 = List.item 1 i45
    and i6 = List.item 0 i67
    and i7 = List.item 1 i67
    and i8 = n5
    and i9 = n4
    and s1 = p1 i1
    and s2 = p2 i2
